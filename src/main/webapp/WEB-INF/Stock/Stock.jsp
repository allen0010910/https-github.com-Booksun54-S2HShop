...
<head>
    ...
    <title>销售管理页面</title>
    <meta name="description" content="销售管理页面">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">销售信息列表</div>
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <div class="am-u-sm-12 am-u-md-12 am-u-lg-3">
                                ...
                                <div class="am-input-group am-input-group-sm tpl-form-border-form cl-p">
                                    ...
                                    <input type="text" class="am-form-field " id="searchtext" placeholder="输入销售单ID">
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt">
    <div class="am-modal-dialog">
        ...
        <input type="hidden" class="am-modal-prompt-input" placeholder="wl" id="addwl">
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt2">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品数量</label>
            <input type="text" class="am-modal-prompt-input" placeholder="商品名数量" id="editnum">
        </div>
        <div class="am-modal-bd">
            <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">销售单价</label>
            <input type="text" class="am-modal-prompt-input" placeholder="销售单价" id="editsellprice">
        </div>
        <input type="hidden" class="am-modal-prompt-input" placeholder="id" id="id_edit">
        <input type="hidden" class="am-modal-prompt-input" placeholder="id" id="id_wlno">
