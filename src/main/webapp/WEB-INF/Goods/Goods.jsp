...
<head>
    ...
    <title>商品管理页面</title>
    <meta name="description" content="商品管理页面">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title  am-cf">商品信息列表</div>
...
<form action="goods_saveGoods.action" method="post" enctype="multipart/form-data" id="myform">
